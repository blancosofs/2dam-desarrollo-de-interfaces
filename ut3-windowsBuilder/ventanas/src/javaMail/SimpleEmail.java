...
public class SimpleEmail {	
	...
	public static void main(String[] args) {
		...
		final String fromEmail = "sofiablanco.cal@gmail.com"; //EMAIL DE SALIDA (no funciona el del colegio)
		final String password = "fvtr pbjr czbk jylm"; //CONTRASEÑA DEL EMAIL DE SALIDA (aplicaciones de 3ros) Contraseñas de aplicación -- Verificación en 2 pasos (https://myaccount.google.com/apppasswords)
		final String toEmail = "sofiablanco.cal@gmail.com"; // EMAIL DESTINATARIO
		
		System.out.println("Configurando datos conexión SSL");
		
		Properties props = new Properties();
		//parejas de key values
